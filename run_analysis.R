...
#Load de features data  and find only the rows that contains mean() or std(), then 
#load only the data of the columns that exists in the features dataframe, in de x_all dataframe.
...
#Load and merge the data of activity_labels with the y_all dataframe, and next, merge the second column
#that contains the activity names with the x_all and subject_all dataframes.
